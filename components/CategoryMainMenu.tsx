...
import { DeleteInfo, reminderID } from "../types";
                ...
                <>
                    {category.id !== reminderID && (
                        <>
                            ...
                            <TouchableOpacity
                                style={menuOverlayStyles.menuItemContainer}
                                onPress={handleMakeSecureCategory}
                            >
                            ...
                            >
                                <FontAwesome
                                    name="times"
                                    style={[menuOverlayStyles.icons, menuOverlayStyles.crossIcon]}
                                />
